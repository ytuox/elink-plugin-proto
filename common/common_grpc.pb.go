...
const (
	Common_Ping_FullMethodName         = "/common.Common/Ping"
	Common_Version_FullMethodName      = "/common.Common/Version"
	Common_PluginNotify_FullMethodName = "/common.Common/PluginNotify"
)
...
type CommonClient interface {
	...
	PluginNotify(ctx context.Context, in *PluginNotifyRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *commonClient) PluginNotify(ctx context.Context, in *PluginNotifyRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Common_PluginNotify_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CommonServer interface {
	...
	PluginNotify(context.Context, *PluginNotifyRequest) (*emptypb.Empty, error)
...
func (UnimplementedCommonServer) PluginNotify(context.Context, *PluginNotifyRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PluginNotify not implemented")
}
...
func _Common_PluginNotify_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PluginNotifyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommonServer).PluginNotify(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Common_PluginNotify_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommonServer).PluginNotify(ctx, req.(*PluginNotifyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Common_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PluginNotify",
			Handler:    _Common_PluginNotify_Handler,
		},
	},
